...
const Title = ({ children, size, className }) => {
    const titleVariants = (size) => {
        const sizes = {
            ...
            "5xl": "lg:text-5xl sm:text-4xl text-3xl lg:leading-[140%] sm:leading-[130%] leading-[120%]",
    ...
    if (size === "7.5xl") {
        return (
            <h1 className={cn(`font-extrabold text-muted-foreground xl:text-7xl md:text-5xl text-4xl lg:leading-[120%] leading-[130%] ${className}`)}>
                {children}
            </h1>
        )
    }
